...
## superpowers — Enterprise Identity

This repo is **superpowers**: a **zepo** (enterprise infrastructure fork) in Steve's Zgent Enterprise.
...
- **Bead prefix:** `sp`
- **Upstream:** `obra/superpowers` (fetch freely, never push enterprise artifacts to it)
- **Origin:** `justSteve/superpowers`

### Fork Doctrine

This fork exists because Steve deliberately appropriated the intellectual capital
of `obra/superpowers`. This is offensive, not defensive — Steve chose to stand on these
